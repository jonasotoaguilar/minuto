-- Migration: restore_organization_default_timezone
-- Restores canonical org timezone storage using organizations.default_timezone
...
ALTER TABLE public.organizations
ALTER COLUMN default_timezone SET DEFAULT 'America/Santiago';
...
CREATE FUNCTION public.create_organization_with_owner(
  p_name text,
  p_default_timezone text DEFAULT 'America/Santiago'::text,
